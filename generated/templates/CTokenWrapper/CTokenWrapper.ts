...
export class CTokenWrapper__getStatusResult {
  value0: BigInt;
  value1: BigInt;
...
export class CTokenWrapper__subAccountPositionsResult {
  value0: BigInt;
  value1: BigInt;
...
export class CTokenWrapper extends ethereum.SmartContract {
  static bind(address: Address): CTokenWrapper {
    return new CTokenWrapper("CTokenWrapper", address);
  }
  ...
  getStatus(): CTokenWrapper__getStatusResult {
    let result = super.call("getStatus", "getStatus():(uint256,uint256)", []);

    return new CTokenWrapper__getStatusResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }

  try_getStatus(): ethereum.CallResult<CTokenWrapper__getStatusResult> {
    let result = super.tryCall(
      "getStatus",
    ...
    return ethereum.CallResult.fromValue(
      new CTokenWrapper__getStatusResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  withdrawUnitAmount(
    ...
    let result = super.call(
      ...
      [
        ethereum.Value.fromAddress(_to),
        ethereum.Value.fromUnsignedBigInt(_amountUnit),
  ...
  withdrawWrappedAmount(
    ...
    let result = super.call(
      ...
      [
        ethereum.Value.fromAddress(_to),
        ethereum.Value.fromUnsignedBigInt(_amountWrappedToken),
        ethereum.Value.fromBoolean(_claimRewards)
      ]
    );
  ...
  UnitAmtToWrappedAmt_RoundDown(_amountUnit: BigInt): BigInt {
    let result = super.call(
  ...
  UnitAmtToWrappedAmt_RoundUp(_amountUnit: BigInt): BigInt {
    let result = super.call(
  ...
  WrappedAmtToUnitAmt_RoundDown(_amountWrappedToken: BigInt): BigInt {
    let result = super.call(
  ...
  WrappedAmtToUnitAmt_RoundUp(_amountWrappedToken: BigInt): BigInt {
    let result = super.call(
  ...
  prevRatio(): BigInt {
    let result = super.call("prevRatio", "prevRatio():(uint256)", []);

    return result[0].toBigInt();
  }

  try_prevRatio(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("prevRatio", "prevRatio():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  lastHarvest(): BigInt {
    let result = super.call("lastHarvest", "lastHarvest():(uint256)", []);

    return result[0].toBigInt();
  }

  try_lastHarvest(): ethereum.CallResult<BigInt> {
    let result = super.tryCall("lastHarvest", "lastHarvest():(uint256)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  subAccountPositions(
    ...
    _subAccount: Address,
    _FCPaddr: Address
  ): CTokenWrapper__subAccountPositionsResult {
    let result = super.call(
      "subAccountPositions",
    ...
    return new CTokenWrapper__subAccountPositionsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_subAccountPositions(
    ...
    _subAccount: Address,
    _FCPaddr: Address
  ): ethereum.CallResult<CTokenWrapper__subAccountPositionsResult> {
    let result = super.tryCall(
      "subAccountPositions",
      "subAccountPositions(address,address,address):(uint256,int256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new CTokenWrapper__subAccountPositionsResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
...
export class ConstructorCall__Inputs {
  ...
  get _infoOralceAddress(): Address {
...
export class WithdrawUnitAmountCall__Outputs {
  ...
  get _amountWrappedToken(): BigInt {
    return this._call.outputValues[0].value.toBigInt();
  }
}
...
export class EditSubAccountPositionCall__Inputs {
  ...
  get _changeYield(): BigInt {
    return this._call.inputValues[3].value.toBigInt();
  }

  get _changeBond(): BigInt {
