...
export class NGBwrapper__getStatusResult {
  value0: BigInt;
  value1: BigInt;
...
export class NGBwrapper__subAccountPositionsResult {
  value0: BigInt;
  value1: BigInt;
...
export class NGBwrapper extends ethereum.SmartContract {
  static bind(address: Address): NGBwrapper {
    return new NGBwrapper("NGBwrapper", address);
  }
  ...
  getStatus(): NGBwrapper__getStatusResult {
    let result = super.call("getStatus", "getStatus():(uint256,uint256)", []);

    return new NGBwrapper__getStatusResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }

  try_getStatus(): ethereum.CallResult<NGBwrapper__getStatusResult> {
    let result = super.tryCall(
      "getStatus",
    ...
    return ethereum.CallResult.fromValue(
      new NGBwrapper__getStatusResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  subAccountPositions(
    ...
    _subAccount: Address,
    _FCPaddr: Address
  ): NGBwrapper__subAccountPositionsResult {
    let result = super.call(
      "subAccountPositions",
    ...
    return new NGBwrapper__subAccountPositionsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_subAccountPositions(
    ...
    _subAccount: Address,
    _FCPaddr: Address
  ): ethereum.CallResult<NGBwrapper__subAccountPositionsResult> {
    let result = super.tryCall(
      "subAccountPositions",
      "subAccountPositions(address,address,address):(uint256,int256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new NGBwrapper__subAccountPositionsResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
